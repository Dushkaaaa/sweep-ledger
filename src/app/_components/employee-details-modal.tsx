...
//         <section className="w-full max-w-3xl overflow-hidden rounded-[2rem] bg-white shadow-[0_30px_120px_-40px_rgba(15,23,42,0.55)] sm:max-h-[calc(100dvh-3rem)] sm:overflow-y-auto">
//           <div className="bg-linear-to-r from-sky-600 via-cyan-500 to-teal-400 p-5 text-white sm:p-6">
//             <h3 className="text-3xl font-semibold">{safeEmployee.name}</h3>
//           </div>

//           <div className="p-5 space-y-6">
//             <div>
//               <p>Ставка: {safeEmployee.hourlyRate} PLN</p>
//               <p>Години: {totalHours}</p>
//               <p>Аванси: {totalAdvances}</p>
//               <p>До виплати: {pendingPay}</p>
//             </div>

//             <button onClick={handleDeleteEmployee}>Видалити працівника</button>
...
//               <select
//                 value={advanceDay}
//                 onChange={(e) => setAdvanceDay(e.target.value as WorkDayKey)}
//               >
//                 {workDays.map((day) => (
//                   <option key={day.key} value={day.key}>
//                     {day.label}
...
//               <button onClick={handleAddAdvance}>Додати аванс</button>
//             </div>

//             <div>
//               {safeEmployee.advances.map((advance) => (
//                 <div key={advance.id}>
//                   <span>{getWorkDayLabel(advance.day)}</span>
//                   <span>{advance.amount} PLN</span>
//                   <button
...
//             <div>
//               <p>{monthSummary.monthLabel}</p>
//               <p>{monthSummary.totalHours} год</p>
//               <p>{monthSummary.grossPay} PLN</p>
//               <p>{monthSummary.advancesTotal} PLN</p>
//               <p>{monthSummary.pendingPay} PLN</p>
//             </div>
//           </div>
//         </section>
//       </div>
